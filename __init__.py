...
default_app_config = 'idgo_lme_majic.apps.IdgoLmeMajicConfig'
...
logger = logging.getLogger('idgo_lme_majic')
...
OPTIONAL = (
    ...
    ('IDGO_SITE_HEADING_LOGO', None),
    ('IDGO_SITE_HEADING_SECOND_LOGO', None),
    ('IDGO_SITE_HEADING_TITLE', None),
    ('IDGO_COPYRIGHT', None),
    ('IDGO_EXPORT_CSV_ODL_EXTENT_LABEL', None),
    ('IDGO_EXPORT_CSV_ODL_EXTENT_PREFIX', None),
    ...
    ('IDGO_FONCTIONAL_REDUCED_TO_PARTNERS', False),
    ('IDGO_CONTRIBUTION_REDUCED_TO_PARTNERS', False),
    ('IDGO_ADMIN_HARVESTER_USER', None),  # Devrait être obligatoire ?
    # extractor
    ('IDGO_EXTRACTOR_CAUTION_MESSAGE', None),
    ('IDGO_EXTRACTOR_SITE_HEADING_LOGO', None),
    ('IDGO_EXTRACTOR_SITE_HEADING_SECOND_LOGO', None),
    ('IDGO_EXTRACTOR_SITE_HEADING_TITLE', None),
    ('IDGO_EXTRACTOR_SITE_CSS', None),
    ('IDGO_EXTRACTOR_SITE_FOOTER', None),
    # idgo-geographic-layer
...
if getattr(settings, 'STATIC_ROOT', None) is not None:
    ...
    MDEDIT_LOCALES_PATH = os.path.join(
        settings.BASE_DIR,
        'idgo/idgo_admin/static/mdedit/config/locales/fr/locales.json')
# finally
